...
from transformers import GPT2TokenizerFast
from langchain.text_splitter import RecursiveCharacterTextSplitter
from langchain_openai import OpenAIEmbeddings  # 已更新
import os
from langchain_community.vectorstores import FAISS  # 已更新
from langchain_community.chat_models import ChatOpenAI  # 已更新
from langchain.chains import ConversationalRetrievalChain
